...
trait ResultsPage extends BasePage{
  ...
  val resultLink3 = By.cssSelector("#result_0 > div:nth-child(1) > div:nth-child(3) > div:nth-child(1) > a:nth-child(1) > h2:nth-child(1)")
  ...
  def clickFirstResult = elementClick(resultLink3)
